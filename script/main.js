...
const messages = [
    ...
    "kenalin nama aing lintang",
    "Gue pengen ngomong nih sama nazwa ",
    "tapi bingung juga harus mulai dari mana ",
    "gmna yaaa",
    "gue cuman pengen bilang ",
    "daripada ngilang atau ngegosting",
    "biasain deh berani bauat jujur",
    "aaaaaaaaaaaaaa",
    "makasih ya atas kesempatan buat kenal nazwa",
    "emg mungkin waktu nya aja yang kurang pas ",
    "bisa jadi emng gue nya aja si yang kelamaan kenal lu",
    "atau mungkin emng bukan takdir nyaa aja",
    "jadi gaenak gua pengen deketin lau pas lagi deket sama cwo ",
    "jadi sory lah kalo bgtu",
    "yaudah deh",
    "gue cuman pengen bilang"
...
function setupMusic() {
    const music = document.kocak.mp3 ('backgroundMusic');
